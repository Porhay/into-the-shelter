...
const SettingsPage = () => {
    ...
    const handleUpdateName = async () => {
        if (state.inputName === '' || state.inputName === user.displayName)
            return;
    ...
    const handleFileChange = async (
        ...
        if (e.target.files) {
            ...
            const response = await handleUploadReq(
                user.userId,
                filesArray,
                type,
            );
            ...
            <div className="settings-page">
                        ...
                        <div className="settings-nickname">
                            ...
                            <div className="settings-form">
                                <input
                                    ...
                                    onKeyDown={(e) =>
                                        handleKeyDown(e, handleUpdateName)
                                    }
                ...
                <div className="settings-block">
                    ...
                    <p className="settings-text">
                        (Note, that the biggest image will be used as your main
                        game avatar. Don't worry, you can swap between another
                        avatars directly while playing)
                    </p>
